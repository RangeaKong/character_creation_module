...
def attack(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        damage_warrior = 5 + randint(3, 5)
        return (
            f'{char_name} нанёс урон противнику равный {damage_warrior}')
    if char_class == 'mage':
        damage_mage = 5 + randint(5, 10)
        return (
            f'{char_name} нанёс урон противнику равный {damage_mage}')
    if char_class == 'healer':
        damage_healer = 5 + randint(-3, -1)
        return (
            f'{char_name} нанёс урон противнику равный {damage_healer}')
